            ...
            Padding(
              ...
              child: Row(
                ...
                crossAxisAlignment: CrossAxisAlignment
                    .center, // Agregado para centrar verticalmente
                                        ...
                                        top[index]["isTopBranch"] == true
                                            ? Row(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    '${" Top 1 de " + top[index]["branchMerit"]} ',
                                                            ...
                                                            child: jwt !=
                                                                ...
                                                                ? ElevatedButton(
                                                                    onPressed:
                                                                      ...
                                                                      int foundIndex =
                                                                          userBranchesFavorites
                                                                              .indexOf(top.elementAt(index)["id"]);
                                                                      setState(
                                                                          () {
                                                                        if (foundIndex !=
                                                                            -1)
                                                                          ...
                                                                          userBranchesFavorites
                                                                              .add(top.elementAt(index)["id"]);

                                                                        foundIndex =
                                                                            userBranchesFavorites.indexOf(top.elementAt(index)["id"]);
                                                                      });
                                                                      jwt = prefs
                                                                          .getString(
                                                                              'jwt');
                                                                    ...
                                                                    child: !userBranchesFavorites
                                                                            .contains(top.elementAt(index)["id"])
