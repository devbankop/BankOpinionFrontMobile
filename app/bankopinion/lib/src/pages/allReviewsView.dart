                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsets.only(
                                    bottom: 14, top: 8, left: 15, right: 15),
                                child: Row(
                                  crossAxisAlignment: CrossAxisAlignment.center,
                                    ...
                                    InkWell(
                                      onTap: () async {
                                        if (jwt != null) {
                                          ...
                                          int foundIndex = userFavoriteComments
                                              .indexOf(widget.bank["reviews"]
                                                  .elementAt(i)["id"]);
                                          ...
                                          setState(() {
                                            if (foundIndex != -1) {
                                              ...
                                              userFavoriteComments.add(widget
                                                  .bank["reviews"]
                                                  .elementAt(i)["id"]);
                                            }

                                            foundIndex = userFavoriteComments
                                                .indexOf(widget.bank["reviews"]
                                                    .elementAt(i)["id"]);
                                          });
