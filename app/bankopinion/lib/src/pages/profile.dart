...
class ProfileState extends State<Profile> {
  ...
  Future<void> _getUserProfile() async {
    ...
    var response = await http.get(getUser, headers: {"Authorization": '$jwt'});
            ...
            Padding(
              ...
              child: Container(
                ...
                child: const Icon(Icons.account_circle,
                    color: Color.fromARGB(255, 153, 116, 223), size: 150),
                //fit: BoxFit.cover,
              ),
            ),
            Padding(
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        //Icon(Icons.lock),
                        Text(
                          userData != null && userData.containsKey("surname")
                              ? userData["surname"]
                              : "",
                          style: TextStyle(
                            fontSize: 16,
                      ...
                      children: [
                        error == true
                            ? RichText(
                                text: TextSpan(
                                  text:
                                      "Se ha producido un error eliminando el usuario",
                      ...
                      child: Align(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            var response = await http.delete(deleteUser,
