...
class contactFormViewState extends State<contactFormView> {
  ...
  Future<void> sendForm() async {
   ...
   var body = jsonEncode({
    ...
    final response = await http.post(form,
        body: body, 
        headers: {
              ...
              Padding(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: 'Por favor, cuéntanos cuál es tu duda, sugerencia o problema con el que te has encontrado usando BankOpinion',
                  ),
                  maxLines: 50,
                  minLines: 10,
                ),
              ...
              Padding(
                ...
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: (() async {
                        if(_nameController.text != "" && _emailController.text != "" && _subjectController.text != "" && _messageController.text != "")
                        {
                          sendForm();
                          setState(() {
                            err = false;
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(color: Color.fromARGB(255, 0, 0, 0), fontWeight: FontWeight.w500, fontSize: 16),
                  ),
                ),
                Padding(
                  padding: EdgeInsets.all(16),
